<div class="page-header">
  <h2><i class="fa fa-plus-circle me-2"></i>Thêm danh mục mới</h2>
...
<div class="form-card">
  <form method="POST" action="?page=create-category" enctype="multipart/form-data">
    ...
    <div class="form-grid">
      ...
      <div class="form-group full">
        <label>Mô tả</label>
        <textarea name="content" class="form-control" rows="3" placeholder="Mô tả danh mục..."></textarea>
      </div>
      ...
      <div class="form-group full">
        ...
        <div class="upload-zone" id="uploadZone">
          ...
          <img id="imagePreview" src="" alt="" style="display:none; max-height:180px; border-radius:10px; object-fit:contain;">
        </div>
      </div>
